...
public class GrapefruitTeaFactoryTester extends BaseTester {
	private TeaTester teaTester;
	private TeaFactoryTester teaFactoryTester;
	public final double defaultWeight = 1;

	public GrapefruitTeaFactoryTester(TeaTester teaTester, TeaFactoryTester teaFactoryTester) throws ClassNotFoundException, TesterGotNoClassNameException {
		super.className = ClassName.GRAPEFRUIT_TEA_FACTORY;
