...
public class PremiumLotusTeaFactoryTester extends BaseTester {
	private TeaTester teaTester;
	private TeaFactoryTester teaFactoryTester;
	public final double defaultWeight = 1;

	public PremiumLotusTeaFactoryTester(TeaTester teaTester, TeaFactoryTester teaFactoryTester) throws ClassNotFoundException, TesterGotNoClassNameException {
		super.className = ClassName.PREMIUM_LOTUS_TEA_FACTORY;
