...
echo Running Grader titled "Midterm 254"...
echo Make sure you have installed JDK version 19 or higher and downloaded MidtermGrader254.jar,
echo then placed it in the same directory as this batch file.

java -cp MidtermGrader254.jar student/StudentGrader
pause
exit