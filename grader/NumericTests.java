...
import grader.submissions.Main;
...
public class NumericTests {
    ...
    public static List<TestCase> getAllTests() {
        ...
        // Test 1: Sum (20 pts)
        tests.add(createNumericTest(
            "Test 1: Sum of 5 and 3",
            20,
            "5\n3\n",
            8,
            "Expected: 8 (5 + 3)"
        ...
        tests.add(createNumericDoubleTest(
            "Test 2: Average of 10 20 30",
            30,
            "10\n20\n30\n",
            20.0,
            0.01,
    ...
    private static TestCase createNumericDoubleTest(String name, int points, String input, double expected, double tolerance, String feedback) {
        return new TestCase() {
            @Override
			public String getName() { return name; }
            @Override
