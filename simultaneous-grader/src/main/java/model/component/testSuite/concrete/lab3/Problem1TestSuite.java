...
public class Problem1TestSuite extends TestSuite {
	private static Problem1TestSuite instance;

	public static Problem1TestSuite getInstance() {
		if (instance == null) {
			instance = new Problem1TestSuite();
		}
		return instance;
	}
